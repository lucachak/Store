...
class Subscription(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.stripe_id:
            stripe_id = Core.billing.create_product(name=self.name,
...
class SubscriptionPrice(models.Model):
    ...
    interval = models.CharField(max_length=120, 
                                default=IntervalChoices.MONTHLY, choices=IntervalChoices.choices)
    ...
    def display_features_list(self):
        if not self.subscription:
            ...
            return self.subscription.display_features_list()
